...
.rich_media_global_msg .icon_closed {
	...
	-webkit-tap-highlight-color: rgba(0, 0, 0, 0);
	background: transparent
		url(/mmbizwap/zh_CN/htmledition/images/icon/appmsg/icon_appmsg_msg_closed_sprite.2x.png)
		no-repeat 0 0;
	width: 11px;
	height: 11px;
	vertical-align: middle;
		...
		<div class="rich_media_inner">
			<div id="page-content">
				<div id="img-content" class="rich_media_area_primary">
					<h2 class="rich_media_title" id="activity-name">${art.artName }</h2>
					<div class="rich_media_content " id="js_content">
						<p style="text-align: center;"><img width="779" src="<%=AliyunUpload.IMAGE_DOMAIN%>/${art.artImage}" /></p>
						<c:if test="${not empty art.artAudio }">
						<p style="text-align: center;"><audio controls autoplay src="<%=AliyunUpload.AUDIO_DOMAIN%>/${art.artAudio}">你的浏览器不支持</audio></p>
						</c:if>
						<p style="text-align: center;">编号：${art.artNumber }</p>
						<p style="text-align: center;">名称：${art.artName }</p>
						<p style="text-align: center;">尺寸：${art.artSize }</p>
						<p style="text-align: center;">材质：${art.artMaterial }</p>
						<p style="text-align: center;">作者：${art.artAuthor }</p>
						<p style="text-align: center;">证书：${art.artCert }</p>
						<p style="text-align: center;">年份：${art.artYear }</p>
						<p style="text-align: center;">
						</p>
						<p style="text-align: left;">描述:<span style="font-size: 16px;"><span style="font-family: 宋体;">${art.artDesc }</span></span>
						</p>
						<p style="text-align: center;">
							<br />
						</p>
					...
					<div class="ct_mpda_wrp" id="js_sponsor_ad_area"
